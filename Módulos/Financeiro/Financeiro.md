...
O sistema deve:
### Contas:
- Cadastrar [[Fatura (FATURAS.DAT)]]
- Consultar [[Fatura (FATURAS.DAT)]]
- Alterar informações de [[Fatura (FATURAS.DAT)]] abertas
- Vincular [[Fatura (FATURAS.DAT)]] a [[Internação (INTER.DAT)]]
### Exames:
...
- Vincular [[Item da Conta]] a [[Fatura (FATURAS.DAT)]]
